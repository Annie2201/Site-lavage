...
<div class="container" style="width: 1108px;"> 
    <h2>Prix de voiture deux roues</h2>
    <table border="1">
        <tr>
    ...
    $reponse= $base->query('SELECT * FROM prix_lavage as pl JOIN categorie AS ct ON pl.id_categorie = ct.id_categorie WHERE pl.id_categorie = 1');
